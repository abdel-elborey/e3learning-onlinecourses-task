...
<body>
	...
	<form:form method="POST" commandName="account" id="accountForm">
        <table>
            <tr>
                <td>First Name:</td>
            ...
            <tr>
                ...
                <td><form:errors path="address.streetName" cssStyle="color: #ff0000;"/></td>
            </tr>
            <tr>
                <td>Suburb:</td>
                <td><form:input path="address.suburb" /></td>
                <td><form:errors path="address.suburb" cssStyle="color: #ff0000;"/></td>
            </tr>
            <tr>
                <td>State:</td>
            ...
            <tr>
                ...
                <td><form:select path="address.country.id">
                      <form:options itemLabel="name" itemValue="id" items="${countries}"  />
                       </form:select>
                </td>
                <td><form:errors path="address.country" cssStyle="color: #ff0000;" /></td>
            </tr>
            <tr>
                <td><form:hidden path="status" id="accountStatus"/> <input type="checkbox" id="statuschk" /> Active</td>
                <td colspan="2"> &nbsp;</td>
            </tr>
            ...
            <tr>
				...
				<td><form:select path="training"  multiple="multiple" >
						<form:options items="${availableTraining}" itemLabel="course.title" itemValue="course.id" /> 
					</form:select>
				</td>
			</tr>
